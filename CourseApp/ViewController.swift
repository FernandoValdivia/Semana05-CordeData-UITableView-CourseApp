...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if course.name != nil {
            ...
            if promfinal < 13.0 {
                cell.backgroundColor = #colorLiteral(red: 0.6789290621, green: 0.1444671459, blue: 0.06797411975, alpha: 0.8424657534)
            }else if promfinal >= 13.0 {
                cell.backgroundColor = #colorLiteral(red: 0.3513248984, green: 0.5768886375, blue: 0.2015141349, alpha: 0.8219178082)
            }else{
